...
from cli.extensions import SPEC_URL, append_extension
from cli.local_ai import DEFAULT_OLLAMA_MODEL, LocalAIError, ensure_ollama_available, extract_crumb_block, generate_text
